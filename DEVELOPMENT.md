...
```bash
git remote add encore encore://aesthetic-center-landing-page-bmx2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/aesthetic-center-landing-page-bmx2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/aesthetic-center-landing-page-bmx2/settings/integrations/github)
