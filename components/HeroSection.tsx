...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background gradient - TEMA SCURO RILASSANTE */}
      <div className="absolute inset-0 bg-gradient-to-br from-stone-200 via-amber-100 to-orange-100"></div>
      ...
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-stone-200/30 rounded-full blur-xl animate-pulse delay-500"></div>
    </section>
  )
}
