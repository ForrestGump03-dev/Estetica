import { Calendar, Tag, ArrowRight, PlayCircle, X, ChevronDown, ChevronUp } from 'lucide-react'
import { useState } from 'react'

// Questa interfaccia simula i dati che arriveranno dal CMS (Contentful)
interface NewsItem {
  id: number
...
const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ" // Esempio video
  },
  {
    id: 3,
    type: 'news',
...
export default function NewsSection() {
  ...
  const desktopItems = showAll ? newsItems : newsItems.slice(0, 3)
